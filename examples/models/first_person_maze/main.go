...
*
*   This example has been created using raylib-go v0.0.0-20220104071325-2f072dc2d259 (https://github.com/TheCodeTherapy/graylib)
*   raylib-go is licensed under an unmodified zlib/libpng license (https://github.com/TheCodeTherapy/graylib/blob/master/LICENSE)
*
*   Ported to graylib by TheCodeTherapy (@tTheCodeTherapy), August 2024
*
